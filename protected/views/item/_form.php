...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php /** echo $form->checkBox($model, 'tombochk'); ?>
		<?php echo CHtml::label('Sem Tombo', 'tombochk', array(
				'value'=>'N/A',
	...
	<div class="row">
		...
		<?php /** echo $form->checkBox($model, 'serialchk'); ?>
		<?php echo CHtml::label('Sem Serial', 'serialchk', array(
				'value'=>'N/A',
				'style'=>'display: inline; vertical-align: text-top',
		)); **/ ?>
	</div>
