...
class InternoController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['interno'];
			if($model->save())
	...
	{
		$model=new interno('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['interno']))
			$model->attributes=$_GET['interno'];
	...
	{
		$model=interno::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='interno-form')
		{
